            ...
            <div className="flex flex-col">
                ...
                <div className="overflow-auto rounded-md "    >
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            <th className="px-6 py-3 text-left text-xs font-bold text-green-700 uppercase tracking-wider">Id</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-green-700 uppercase tracking-wider">Name</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-green-700 uppercase tracking-wider">Age</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-green-700 uppercase tracking-wider">Gender</th>
                        ...
                        {beneficiaries.length === 0 ? (
                            <tr>
                                <td colSpan="5" className="text-center py-4 text-gray-500">No beneficiaries found.</td>
                            </tr>
                        ) : (
                             beneficiaries.map((beneficiary) => (
                                    <tr key={beneficiaries.length}>
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-600">
                                            {beneficiary.children.record.map((record) => (
                                               <li key={record.id} className="flex items-center gap-2">
                                                   <p>{
                                                       record.bmi < 18.5 ? 'Underweight' :
                                                       record.bmi < 24.9 ? 'Normal' :
                                                       record.bmi < 29.9 ? 'Overweight' :
                                                       'Obese'
                                                   }
                                                   </p>
                                               </li>

                        ...
                        <div className='flex flex-col w-full p-4 '>
                            ...
                            <div>
                               <form onSubmit={submitProgram}>
                                ...
                                <div className='flex flex-col mb-2'>
                                    <InputLabel htmlFor="description" value="Desription" />
                                    <TextInput
                                        id="description"
                                        name="description"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3  text-slate-600 text-sm gap-4 mt-2">
                                    ...
                                    <div class="flex flex-col">
                                        <label htmlFor="start_date" className='font-bold'>Duration (days)</label>
                                        <input
                                            type="number"
                                            id="duration"
                                            name="duration"
                                            ...
                                            className=' rounded-lg border border-slate-300 shadow-sm'
                                        />
                                        {errors.start_date && <div>{errors.duration}</div>}
                                    </div>
                                    <div class="flex flex-col">
                                        ...
                                        <input
                                            ...
                                            className=' rounded-lg border border-slate-300 shadow-sm'
                                        />
                                        {errors.start_date && <div>{errors.total_beneficiaries}</div>}
                                    </div>
                                </div>
